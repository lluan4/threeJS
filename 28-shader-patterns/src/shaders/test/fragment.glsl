...
void main()
{
    ...
    // // Pattern 5: Vertical Gradient (Inverted)
    ...
    // // Pattern 8: Stripes (Sharp)
    // float strength = mod(vUv.y * 10.0, 1.0);
    // strength = step(0.5, strength);

    // // Pattern 9: Stripes (Sharp Threshold 0.8)
    // float strength = mod(vUv.y * 10.0, 1.0);
    // strength = step(0.8, strength);

    // // Pattern 10: Stripes (Sharp Threshold 0.8)
    // float strength = mod(vUv.x * 10.0, 1.0);
    // strength = step(0.8, strength);

    // // Pattern 11: Stripes (Sharp Threshold 0.8)
    // float strength = mod(vUv.x * 10.0, 1.0);
    // strength = step(0.8, strength);
    ...
    // float pattern1 = floor(vUv.x * 10.0) / 10.0;
    // float pattern2 = floor(vUv.y * 10.0) / 10.0;
    // vec2 gridUv = vec2(pattern1, pattern2);

    // float strength = random(gridUv);

    // // Pattern 25
    // float pattern1 = floor(vUv.x * 10.0 ) / 10.0;
    // float pattern2 = floor(vUv.y * 10.0  + vUv.x * 5.0) / 10.0  ;
    // vec2 gridUv = vec2(pattern1, pattern2);
